...
var drawingApp = (function () {
    ...
    do {
        canvasTop += element.offsetTop  || 0;
        canvasLeft += element.offsetLeft || 0;
		...
		createUserEvents = function () {
            var press = function (e) {
				...
				var sizeHotspotStartX,
					mouseX = (e.changedTouches ? e.changedTouches[0].pageX : e.pageX) - canvasLeft,
					mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - canvasTop;
			...
			drag = function (e) {
				var mouseX = (e.changedTouches ? e.changedTouches[0].pageX : e.pageX) - canvasLeft,
					mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - canvasTop;
